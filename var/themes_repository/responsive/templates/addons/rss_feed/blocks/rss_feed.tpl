...
<defs>
<symbol id="ty-icon-feed" viewBox="0 0 1024 1024">
    <title>feed</title>
...
<a class="rss-feed cm-no-ajax" href="{"rss.view?lang=`$smarty.const.CART_LANGUAGE`&bid=`$block.block_id`&sid=`$block.snapping_id``$param`"|fn_url}"><svg class="ty-icon-feed"><use xlink:href="#ty-icon-feed"></use></svg></a>