...
// Collect statictic. If get content function is unablailable - do not show the errors
@fn_get_contents(Registry::get('config.resources.updates_server') . '/index.php?dispatch=product_updates.reverted');
