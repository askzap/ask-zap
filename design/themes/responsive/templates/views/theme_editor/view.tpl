        ...
        <div class="te-inner-wrap">
            <div class="te-general-group">
                ...
                <div class="te-image te-favicon-wrap clearfix">
                    <span class="te-bg-title">{__("theme_editor.favicon")}&nbsp;<i class="ty-icon-help-circle cm-tooltip" title="{__("theme_editor.favicon_size")}"></i></span>{include file="views/theme_editor/components/fileuploader.tpl" var_name="logotypes_image_icon[`$id`]" disabled=$current_style.is_default}
                    ...
                    <div class="attach-images">
                        <div class="upload-box clearfix">
                            ...
                            <div class="te-logos-upload clearfix">
                                ...
                                {include file="views/theme_editor/components/fileuploader.tpl" var_name="logotypes_image_icon[`$id`]" disabled=$current_style.is_default}
                            </div>
                            {/hook}
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div id="backgrounds_adv_pattern_{$name}" class="te-bg-advanced hidden">
                        {if $field.properties.pattern}
                            ...
                            {include file="views/theme_editor/components/fileuploader.tpl" var_name="backgrounds[`$field.properties.pattern`]" disabled=$current_style.is_default}
                            </div>
                        {/if}
