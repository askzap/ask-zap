                        ...
                        {if !$non_editable}
                            {if $href_delete && !$skip_delete}
                                ...
                                {else}
                                    ...
                                    {$href=$href_delete}
                                {/if}
                                <li>{btn type="text" text=__("delete") href=$href class="cm-confirm cm-tooltip cm-ajax cm-post cm-ajax-force cm-ajax-full-render `$class`" data=["data-ca-target-id" => $delete_target_id, "data-ca-params" => $delete_data]}</li>
                            {/if}
                        {/if}
                    {/capture}
