<div class="control-group">
    <label class="control-label" for="rapid_username">{__("api_key")}:</label>
    <div class="controls">
...
<div class="control-group">
    <label class="control-label" for="rapid_password">{__("api_password")}:</label>
    <div class="controls">
...
<div class="control-group">
    <label class="control-label" for="rapid_encryption_key">{__("encryption_key")}:</label>
    <div class="controls">
