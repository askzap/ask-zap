                            ...
                            {capture name="tools_list"}
                                {hook name="languages:list_extra_links"}
                                    ...
                                    {if $language.lang_code != $smarty.const.DEFAULT_LANGUAGE}
                                        <li>{btn type="list" class="cm-confirm cm-post" text=__("delete") href="languages.delete_language?lang_id=`$language.lang_id`"}</li>
                                    {/if}

                                    <li>{btn type="list" class="cm-language-name cm-post" text=__("clone") href="languages.clone_language?lang_id=`$language.lang_id`"}</li>
                                    <li>{btn type="list" class="cm-post" text=__("export") href="languages.export_language?lang_id=`$language.lang_id`"}</li>
...
{capture name="buttons"}
    {capture name="tools_list"}
        {hook name="languages:manage_tools_list"}
            <li>{btn type="list" class="cm-post" text=__("on_site_live_editing") href="customization.update_mode?type=live_editor&status=enable"|fn_url target="_blank"}</li>
            <li class="divider"></li>
