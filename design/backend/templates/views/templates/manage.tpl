...
{capture name="buttons"}
    {capture name="tools_list"}
        ...
        <li class="cm-te-onsite-editing">{btn type="list" text=__("on_site_template_editing") href="customization.update_mode?type=design&status=enable&return_url=`$current_url`"|fn_url target="_blank" class="cm-post"}</li>
        <li class="divider"></li>
        {/hook}
