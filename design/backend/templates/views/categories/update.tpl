    ...
    {if $id}
        ...
        {capture name="tools_list"}
            {hook name="categories:update_tools_list"}
                ...
                <li>{btn type="list" class="cm-confirm cm-post" text=__("delete_this_category") data=["data-ca-confirm-text" => "{__("category_deletion_side_effects")}"] href="categories.delete?category_id=`$id`"}</li>
            {/hook}
        {/capture}
