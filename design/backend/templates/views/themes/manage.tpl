...
<div class="span8 theme-description" id="theme_description_container">
                    ...
                    <tr>
                        ...
                        <td class="right btn-toolbar">
                            {if $available_layout.is_default}
                                {$is_default = "btn-small btn-primary cm-post"}
                            {else}
                                {$is_default = "btn-small cm-post"}
                            {/if}
    ...
    {else}
        <div class="theme-no-styles">
            ...
            {include file="buttons/button.tpl" but_href="customization.update_mode?type=theme_editor&status=enable" but_text=__("visual_editor") but_role="action" but_meta="btn-primary cm-post"}
        </div>
    {/if}
    {/hook}
            ...
            {else}
                <div class="span4">
                    <div class="theme">
                        ...
                        {if $theme_name != $runtime.layout.theme_name}
                            <div class="theme-use">
                                {include file="buttons/button.tpl" but_href="themes.set?theme_name=`$theme_name`&amp;style=`$style.style_id`" but_text=__("activate") but_role="action" but_meta="btn-primary cm-post"}
                            </div>
                        {/if}
