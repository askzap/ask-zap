    ...
    $(document).ready(function(){
        $(_.doc).on('click', '[id*=elements-switcher-]', function(){
            ...
            $('[id*=' + id + ']').each(function(index, element){
                $(element).toggleClass(getFieldType(element), !checked);
                ...
                <tr>
                    ...
                    {elseif $field == "features"}
                        {if $all_product_features}
                            ...
                            {include file="views/products/components/products_m_update_features.tpl" product_features=$all_product_features features_search=$all_features_search product_id=0 over=true data_name="override_products_data"}
