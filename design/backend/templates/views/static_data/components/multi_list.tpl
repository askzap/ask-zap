        ...
        <td class="nowrap">
            <div class="pull-right hidden-tools">
                {capture name="tools_list"}
                    ...
                    <li>{btn type="list" text=__("delete") href="static_data.delete?param_id=`$item.param_id`&section=`$section`&`$owner_condition`" class="cm-confirm cm-ajax cm-post cm-delete-row"  data=['data-ca-target-id'=>'static_data_list']}</li>
                {/capture}
