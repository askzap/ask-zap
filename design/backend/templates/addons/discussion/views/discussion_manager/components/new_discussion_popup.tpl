        ...
        <form id='form' action="{""|fn_url}" method="post" class="form-horizontal form-edit cm-disable-empty-files" enctype="multipart/form-data">
            ...
            <div class="cm-tabs-content cm-no-hide-input" id="content_tab_add_post">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        {include file="common/calendar.tpl" date_id="post_data_timestamp" date_name="post_data[date]" date_val=$post_data.timestamp|default:$smarty.const.TIME start_year=$settings.Company.company_start_year}
                        <input class="input-time" size="5" maxlength="5" type="text" name="post_data[time]" value="{$smarty.const.TIME|date_format:"%H:%M"}" placeholder="00:00" />
                    </div>
                </div>
