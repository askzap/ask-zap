...
<tr>
    ...
    <td class="nowrap right">
        {capture name="tools_list"}
            <li>{btn type="list" class="cm-confirm cm-post" text=__("delete") href="em_subscribers.delete?subscriber_id=`$s.subscriber_id`"}</li>
        {/capture}
...
{else}
    <div class="no-items">
        ...
        <p>
        {btn type="text_add" class="cm-post" text=__("import") href="em_subscribers.import"|fn_url}
        </p>
        {/if}
    </div>
{/if}
...
{capture name="buttons"}
        ...
        {capture name="tools_list"}
            ...
            <li>{btn type="list" class="cm-post" text=__("email_marketing.sync") href="em_subscribers.sync"}</li>
            {/if}

            {if $subscribers}
            <li>{btn type="list" text=__("export_selected") dispatch="dispatch[em_subscribers.export_range]" form="subscribers_form"}</li>
            <li>{btn type="list" class="cm-post" text=__("email_marketing.export_all") href="exim.delete_range?section=subscribers&pattern_id=em_subscribers"|fn_url}</li>
