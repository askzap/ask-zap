<script type="text/javascript">
    ...
    SearchaniseAdmin.Engines.push({ldelim}
            ...
            PriceFormat: {ldelim}
                ...
                decimals_separator: '{$currencies[$secondary_currency].decimals_separator nofilter}',
                thousands_separator: '{$currencies[$secondary_currency].thousands_separator nofilter}',
