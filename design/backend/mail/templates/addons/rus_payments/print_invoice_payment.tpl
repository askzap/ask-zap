                    ...
                    <td colspan="2" width="360">
                        <div class="ty-text">
                            ...
                            {if $order_info.path_stamp}
                                <div class="ty-stamp"><img src="{"orders.get_stamp&payment_id=`$order_info.payment_method.payment_id`"|fn_url}" alt="stamp" width="{$account_settings.account_print_width}" height="{$account_settings.account_print_height}" /></div>
                            {/if}
                        </div>
                    </td>
                </tr>
