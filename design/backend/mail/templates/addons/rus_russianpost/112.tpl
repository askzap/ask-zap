...
<body style="width:  210mm; height: 297mm;">
    <div style="top: {$addons.rus_russianpost.112_top}mm; left: {$addons.rus_russianpost.112_left}mm; width: {$addons.rus_russianpost.112_list_width}mm; height: {$addons.rus_russianpost.112_list_height}mm; position: relative;" >
        ...
        {if $data.sms_for_sender == 'Y'}
            <div style="position: absolute;height: 4.5mm;width: 38mm;top: 61mm;left: 155.7mm;font: 11pt 'Arial';margin: 0; ">
        ...
        {if $data.sms_for_recepient == 'Y'}
            <div style="position: absolute;height: 4.5mm;width: 38mm;top: 67mm;left: 155.7mm;font: 11pt 'Arial';margin: 0; ">
        ...
        <span style="position: absolute;height: 5.5mm;width: 188mm;top: 80mm;left: 6mm;font: 11pt 'Arial';text-indent: 12mm;line-height: 18pt;">{if $data.sender == '1'}{$data.where}{else}{$data.fiz_addres}{/if}</span>
        ...
        <div style="position: absolute;height: 4.5mm;width: 55mm;top: 95mm;left: 31.7mm;font: 11pt 'Arial';margin: 0; ">
