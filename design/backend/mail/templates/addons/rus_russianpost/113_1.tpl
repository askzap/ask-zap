    ...
    <div style="width: {$addons.rus_russianpost.113_list_width}mm; height: {$addons.rus_russianpost.113_list_height}mm;">
        <div style="top: {$addons.rus_russianpost.113_top}mm; left: {$addons.rus_russianpost.113_left}mm; width: 195mm; height: 185mm; position: relative; outline: 1px solid rgb(240,240,240)" >
            ...
            {if $data.sender == '1'}
                ...
                <div style="position: absolute;height: 4.5mm;width: 20mm;top: 75mm;left: 172.5mm;font: 11pt 'Arial';margin: 0;">
            ...
            <div style="position: absolute;height: 4.5mm;width: 40mm;top: 84mm;left: 79.7mm;font: 11pt 'Arial';margin: 0; ">
                ...
                <span style="position: absolute; left: 3mm;">{$data.inn.1}</span>
                <span style="position: absolute; left: 6mm;">{$data.inn.2}</span>
                <span style="position: absolute; left: 9mm;">{$data.inn.3}</span>
                <span style="position: absolute; left: 12mm;">{$data.inn.4}</span>
                <span style="position: absolute; left: 15mm;">{$data.inn.5}</span>
                <span style="position: absolute; left: 18mm;">{$data.inn.6}</span>
                <span style="position: absolute; left: 21mm;">{$data.inn.7}</span>
                <span style="position: absolute; left: 24mm;">{$data.inn.8}</span>
                <span style="position: absolute; left: 27mm;">{$data.inn.9}</span>
            </div>
            ...
            <div style="position: absolute;height: 4.5mm;width: 100mm;top: 94mm;left: 87mm;font: 11pt 'Arial';margin: 0; ">
            ...
            <div style="position: absolute;height: 4.5mm;width: 30mm;top: 94mm;left: 163.5mm;font: 11pt 'Arial';margin: 0; ">
            ...
            <div style="position: absolute;height: 4.5mm;width: 19mm;top: 148mm;left: 173mm;font: 11pt 'Arial';margin: 0; ">
