...
<body style="width: 141mm; height: 200mm;">
    <div style="width: 141mm; height: 200mm; position: relative;" >
        ...
        <span style="position: absolute;height: 5.5mm;width: 113mm;top: 91mm;left: 17mm;font: 10pt 'Arial';">{if $data.sender == '1'}{$data.where}{else}{$data.fiz_addres}{/if}</span>
        ...
        <span style="position: absolute; height: 5.5mm; width: 36mm; top: 159mm; left: 22mm; text-align: center; font: 10pt 'Arial';">{if $data.not_total && $data.total_cod}б/ц{elseif $data.clear_total_cen}{$data.clear_total_cen}{else}б/ц{/if}</span>
