...
<body style="width: 297mm; height: 210mm;">
    <div style="top: {$addons.rus_russianpost.7b_top}mm; left: {$addons.rus_russianpost.7b_left}mm; width: 148mm; height: 105mm; position: relative;" >
        {if $data.print_bg == 'Y'}
        ...
        <span style="position: absolute;height: 5.5mm;width: 31mm;top: 58mm;left: 33.5mm;font: 12pt 'Arial';">          
            {if $data.sender == '1'}
        ...
        <span style="position: absolute;height: 5.5mm;width: 31mm;top: 76mm;left: 114.2mm;font: 12pt 'Arial';">
